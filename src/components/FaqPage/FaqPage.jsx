    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <div className="flex flex-col gap-4">
          <p className='mlfont-400 py-8 px-16 md:px-28 bg-light-green text-center'>നിങ്ങൾ ഈ വർഷം നട്ട് വളർത്തുന്ന വൃക്ഷത്തൈകളുടെ ഫോട്ടോ ഈ വെബ്സൈറ്റിൽ അപ്ലോഡ് ചെയ്യുക. നറുക്കെടുപ്പിലൂടെ തിരഞ്ഞെടുക്കുന്നവർക്ക് സമ്മാനങ്ങൾ നൽകുന്നു. ഓരോ മൂന്ന് മാസം കഴിയുമ്പോഴും വീണ്ടും അതെ തൈകളുടെ ഫോട്ടോ അപ്ലോഡ് ചെയ്യുക. 1000 തൈകൾ അപ്ലോഡ് ചെയ്യപ്പെടുന്ന ഓരോ മൂന്ന് മാസങ്ങളിലും പ്രത്യേകം നറുക്കെടുപ്പ് നടത്തി വർഷത്ൽ നാല് തവണയായി തിരഞ്ഞെടുക്കുന്നവർക്ക് സമ്മാനങ്ങൾ നൽകുന്നു. ഇത് വരെ നടന്ന നറുക്കെടുപ്പുകളുടെ വിവരങ്ങൾ അറിയാൻ ഇവിടെ <a href="#">Click</a> ചെയ്യുക.</p>
          <div className='mlfont-400 my-4 mx-2 md:mx-20'>
            <Section title={'എങ്ങിനെ അപ്ലോഡ് ചെയ്യാം?'}>
              ...
              <a href="https://www.youtube.com/watch?v=383pybukdXk" className='underline'>തൈകൾ അപ്‌ലോഡ് ചെയുന്ന വീഡിയോ കാണാൻ Click Here</a>
              <p>സംശയങ്ങൾക്ക് 9645 9645 92 എന്ന നമ്പറിൽ വിളിക്കുക</p>
            </Section>
            <Section title={'എന്താണ് TREE NUMBER?'}>
            ...
            <Section title={'എന്താണ് GROUP CODE?'}>
              <p>
